#!/usr/bin/env python3
"""
Run the full three-phase experiment pipeline on AG News.
...
Usage:
    ...
    python scripts/run_all_ag_news.py --dry-run
    python scripts/run_all_ag_news.py --skip-to random_search
    python scripts/run_all_ag_news.py --skip-to reruns
    python scripts/run_all_ag_news.py --skip-to plots
"""
...
CONFIG = PROJECT_ROOT / "configs" / "ag_news_textcnn.json"
...
def main():
    parser = argparse.ArgumentParser(description="Full AG News experiment pipeline.")
    ...
    results_dir = PROJECT_ROOT / "results" / "ag_news"
